...
class Ui_SecretSharingEncryption(object):
    ...
    def encrypt_img(self):
        ...
        if self.label_29.pixmap() is None:
            ...
            self.error_message = QtWidgets.QMessageBox(QtWidgets.QMessageBox.Critical, "Error", "Some of the number of divisions is not good")
            self.error_message.exec_()
        else:
    ...
    def encrypt_text(self):
        ...
        if self.textEdit.toPlainText() is None or self.textEdit.toPlainText() == "":
            self.error_message = QtWidgets.QMessageBox(QtWidgets.QMessageBox.Critical, "Error", "Please enter text for encryption")
            self.error_message.exec_()
    ...
    def decrypt_text(self):
        if self.textEdit.toPlainText() is None or self.textEdit.toPlainText() == "":
            ...
            self.error_message = QtWidgets.QMessageBox(QtWidgets.QMessageBox.Critical, "Error", "Not enough parts entered")
            self.error_message.exec_()
        else:
    ...
    def retranslateUi(self, SecretSharingEncryption):
        ...
        SecretSharingEncryption.setWindowTitle(_translate("SecretSharingEncryption", "SecretSharingEncryption"))
        self.toolBox.setWhatsThis(_translate("SecretSharingEncryption", "<html><head/><body><p><br/></p></body></html>"))
        self.image.setWhatsThis(_translate("SecretSharingEncryption", "<html><head/><body><p>Image Encryption/Decryption</p></body></html>"))
        self.pushButton.setText(_translate("SecretSharingEncryption", "Select an Image"))
        self.pushButton_2.setText(_translate("SecretSharingEncryption", "Encrypt"))
        self.label.setText(_translate("SecretSharingEncryption", "Number of Divisions:"))
        self.label_2.setText(_translate("SecretSharingEncryption", "Necessary parts for reconstruction:"))
        self.label_3.setText(_translate("SecretSharingEncryption", "Parts of secret image"))
        self.label_4.setText(_translate("SecretSharingEncryption", "Location of Divisions:"))
        self.label_5.setText(_translate("SecretSharingEncryption", "Link"))
        self.label_5.setStyleSheet("color: #e6f5ff")
        self.pushButton_4.setText(_translate("SecretSharingEncryption", "Decrypt"))
        self.label_6.setText(_translate("SecretSharingEncryption", "Selected Parts"))
        self.pushButton_3.setText(_translate("SecretSharingEncryption", "Insert Part"))
        self.label_7.setText(_translate("SecretSharingEncryption", "Decryption result"))
        self.Text.setWhatsThis(_translate("SecretSharingEncryption", "<html><head/><body><p>Encryption and decryption of the entered number</p></body></html>"))
        self.label_8.setText(_translate("SecretSharingEncryption", "Text for encryption"))
        self.pushButton_5.setText(_translate("SecretSharingEncryption", "Encrypt"))
        self.label_9.setText(_translate("SecretSharingEncryption", "Number of Divisions:"))
        self.label_10.setText(_translate("SecretSharingEncryption", "Necessary parts for reconstruction:"))
        self.label_11.setText(_translate("SecretSharingEncryption", "Parts of secret text"))
        self.pushButton_6.setText(_translate("SecretSharingEncryption", "Decrypt"))
        self.label_12.setText(_translate("SecretSharingEncryption", "Text obtained from decryption"))
        self.pushButton_7.setText(_translate("SecretSharingEncryption", "Add a part"))
        self.Number.setWhatsThis(_translate("SecretSharingEncryption", "<html><head/><body><p>Encryption and decryption of the entered Text</p></body></html>"))
        self.label_13.setText(_translate("SecretSharingEncryption", "Encryption Number"))
        self.pushButton_16.setText(_translate("SecretSharingEncryption", "Encrypt"))
        self.label_27.setText(_translate("SecretSharingEncryption", "Necessary parts for reconstruction:"))
        self.label_28.setText(_translate("SecretSharingEncryption", "Number of Divisions:"))
        self.pushButton_17.setText(_translate("SecretSharingEncryption", "Add a part"))
        self.pushButton_18.setText(_translate("SecretSharingEncryption", "Decrypt"))